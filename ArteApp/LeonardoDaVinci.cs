...
namespace ArteApp
{
    public partial class LeonardoDaVinci : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int indiceImagenSeleccionada = 0;// Cambia este label según el cuadro correspondiente
            favoritosForm.AddFavorite(pictureBox1.Image, artworkName, indiceImagenSeleccionada); // Cambia este PictureBox según el cuadro correspondiente
        ...
        {
            string artworkName = label14.Text;
            int indiceImagenSeleccionada = 0;
